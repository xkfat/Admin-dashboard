        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 bg-white bg-opacity-20 border-0 rounded-full text-white placeholder-white placeholder-opacity-70 focus:outline-none focus:bg-opacity-30 transition-all text-base"
              required
            />
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
              <svg className="w-5 h-5 text-findthem-button opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
